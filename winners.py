...
# uses randrange to generate a 5 index list with numbers ranging from
# 1 to 69
...
def print_gamble_stats(win_count, gamble_count, winnings):
    winning_percent = ( win_count / gamble_count ) * 100
    print("Number of wins: {}".format(win_count))
    print("Winnings: {}".format(millify(winnings)))
    print("Number of tries: {}".format(millify(gamble_count)))
    print("Winning percent: {}".format(winning_percent))
    print("\n\n")
...
if __name__ == "__main__":
    ...
    while winnings > 0:
        ...
        if gamble_count == 1:
            # option 1,
            # interactive user input used to choose Mega Million numbers
            ...
            # option 2,
            # randomly select Mega Million numbers
        ...
        # looks at the last 100,000 winning numbers, and changes
        # chosen_nums to that list of numbers.
        # also resets the chosen_special_num based on which number was
        # most commonly found in the past 100,00 iterations
